...
class SelectMenu  {
    ...
    fun addOrder (menu: List<Menu>) {
        ...
        addOrderLoop@ while (true) {
            ...
            if (orderSelector == 0) break  // 0을 입력하면 루프를 벗어나고 main으로 돌아감


            // 메뉴에 있는 index가 입력되면 (해당번호 - 1)값으로 메뉴들을 출력 (인덱스 번호는 입력 숫자보다 1 작기때문에)
            println("\n==========================================================================================")
            ...
            when (yesOrNo) {
                ...
                2 -> break      // 아니오 선택시 루프 반복 (현재 메뉴를 다시 보여줌, main으로 가는게 아님)
